...
class CardMyQuestionAdapter(val items: Array<DataCardQuestions>): RecyclerView.Adapter<CardMyQuestionAdapter.ViewHolder>() {

    private var mOnClicklistener: View.OnClickListener? = null
    private var isClickable = true

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.card_layout_my_question, parent, false)
        return ViewHolder(v)
    }
