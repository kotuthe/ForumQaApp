...
class RecyclerPostImageAdapter(private val context: Context, val items: ArrayList<Uri?>):
    ...
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): RecyclerView.ViewHolder {
        ...
        if (p1 == ITEM_TYPE_ADD) {
            // 追加
            val view = inflater.inflate(R.layout.recycler_item_post_image_add, p0, false)
