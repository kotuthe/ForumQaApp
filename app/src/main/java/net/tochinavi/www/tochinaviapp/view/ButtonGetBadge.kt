...
class ButtonGetBadge(context: Context, attr: AttributeSet) : androidx.appcompat.widget.AppCompatButton(context, attr, R.attr.borderlessButtonStyle) {

    init {
        this.setBackgroundResource(R.drawable.btn_get_badge)
